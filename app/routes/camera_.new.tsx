    ...
    <main>
      <div className="main-content">
        ...
        <form className="mb-2 text-xl" method="post">
          {searchParams.has("reloaded") ? <WarnToast>Camera was removed because page was refreshed.</WarnToast> : null}
          {searchParams.has("error") ? <ErrorToast>{searchParams.get("error") === "409" ? "Camera with the name exists" : "Error"}</ErrorToast> : null}
          <div className="mb-2">
